...
export const categoryReducer = (state, action) => {
  ...
  switch (type) {
    ...
    case DELETE_CATEGORY:
      return {
        ...state,
        categorys: state.categorys.filter((category) => category._id !== payload),
      };
    ...
    case UPDATE_CATEGORY:
      const newCategorys = state.categorys.map((category) => (category._id === payload._id ? payload : category));
